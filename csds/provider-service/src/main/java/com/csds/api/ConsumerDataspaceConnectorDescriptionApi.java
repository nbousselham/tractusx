...
public interface ConsumerDataspaceConnectorDescriptionApi {
	...
	String getAllCatalog(URI baseUrl, @RequestHeader("Authorization") String authHeader,
			@RequestParam("recipient") String recipient, @RequestParam("elementId") String elementId);

	@PostMapping(path = "/ids/description", consumes = MediaType.TEXT_PLAIN_VALUE)
	String getAllOffer(URI baseUrl, @RequestHeader("Authorization") String authHeader,
			@RequestParam("recipient") String recipient, @RequestParam("elementId") String elementId);

	@PostMapping(path = "/ids/description", consumes = MediaType.TEXT_PLAIN_VALUE)
	String accessData(URI baseUrl, @RequestHeader("Authorization") String authHeader,
			@RequestParam("recipient") String recipient, @RequestParam("elementId") String elementId);
}
