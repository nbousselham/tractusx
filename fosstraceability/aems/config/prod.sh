...
export ACCOUNT_ID="709771689624"
export ECR_REPO_NAME="asset-exchange-prod-registry"
export NPM_CORE_REPO_NAME="partchain-core"
export NPM_DOMAIN="partchain"
export NPM_REPOSITORY_REGION="eu-west-1"
...
if [[ "${ENVIRONMENT}" ]]; then
    ...
    readonly DELETE_ON_FAILURE="Yes"
    export DELETE_ON_FAILURE

    readonly CROSS_ACC_ROLE=eks-crossaccount-deployment
