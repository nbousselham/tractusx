...
export ECR_REPO_NAME=asset-exchange-cx-prod-registry
...
if [[ "${ENVIRONMENT}" ]]; then
    ...
    readonly KUBERNETES_SECRET="cx-prod/${PROJECT_NAME}/kubernetesconfig"
    ...
    readonly CROSS_ACC_ROLE=cx-prod-eks-crossaccount-deployment
