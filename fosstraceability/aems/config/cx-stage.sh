...
export ECR_REPO_NAME=asset-exchange-cx-stage-registry
...
if [[ "${ENVIRONMENT}" ]]; then
    ...
    readonly KUBERNETES_SECRET="cx-stage/${PROJECT_NAME}/kubernetesconfig"
    ...
    readonly CROSS_ACC_ROLE=cx-stage-eks-crossaccount-deployment
